        ...
        {tutor.length === 0 ? (
          ...
          <div>
            {tutor.map((tutor, index) => {
              ...
              return (
                <>
                  <div key={index} value={index} class='m-5 w-1/2'>
                    <div>
                      <a
                        class='relative block p-8 border border-gray-200 shadow-xl rounded-xl'
                        onClick={() => {
                          handleModal(index);
                        }}>
                        ...
                        <div class='mt-4 text-gray-500 sm:pr-8'>
                          ...
                          <p class='hidden mt-2 text-sm sm:block'>
                            Levels: {tutor.classLevel.join(", ")} <br />
                            Subjects: {tutor.subjects.join(", ")} <br />
                            Rate/lesson: ${tutor.rates} <br />
                            Location: {tutor.region} <br />
                            Ratings: {tutor.rating}/5
                          </p>
                        </div>
                        {!inFav ? (
                          <button
                            class=' mt-3 px-12 py-2 text-sm font-medium text-white transition bg-rose-600 border border-black-600 rounded-md shrink-0 hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 '
                            onClick={() => handleFavTutor(tutor)}>
                            <AiOutlineStar /> Favourite
                          </button>
                        ) : (
                          <button
                            class=' mt-3 px-12 py-2 text-sm font-medium text-white transition bg-gray-800 border border-black-600 rounded-md shrink-0 hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 '
                        ...
                        <br />
                        {inPending === 1 && (
                          <button class=' mt-3 px-12 py-2 text-sm font-medium text-black transition bg-yellow-400 border border-black-600 rounded-md shrink-0 '>
                            Your Tutor!
                          </button>
                        )}
                        ...
                        {inPending === 0 && (
                          <button
                            ...
                            class=' mt-3 px-12 py-2 text-sm font-medium text-white transition bg-blue-700 border border-black-600 rounded-md shrink-0 hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 '>
                            Send Request
                          </button>
                        )}
                        ...
                        {inPending === 2 && (
                          <button
                            ...
                            class=' mt-3 px-12 py-2 text-sm font-medium text-white transition bg-gray-700 border border-black-600 rounded-md shrink-0 hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 '>
                            <TiCancel />
                            Cancel Request
                          </button>
                        )}
                        {!favUnfavSuccessful && (
                          <p>Unable to fav/unfav tutor.</p>
                        )}
                        {!updatePendingSuccessful && (
                          <p>Unable to send/cancel request.</p>
                        )}
                      </a>
                    </div>
                  </div>
            ...
            {!(page === 0) && (
              <button
                ...
                class='ml-10 mb-10 px-12 py-5 text-sm font-medium text-white transition bg-amber-600 border border-black-600 rounded-md shrink-0 hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 '>
